    ...
    <div class="mbr-testimonials mbr-section mbr-section-nopadding">
        <div class="container">
            ...
            Tipo de persona: <select id="cmbTipoPersona">
                             ...
                             <input type="checkbox" class="form-control" id="checkTermEmp"/><a href="#" onclick="window.open('Terminos-y-condiciones.pdf')">He leido términos y condiciones</a>
                        ...
                        <input type="checkbox" class="form-control" id="checkTermPer"/><a href="#" onclick="window.open('Terminos-y-condiciones.pdf')">He leido términos y condiciones</a>
                            <?php
                              }
                            ?>
